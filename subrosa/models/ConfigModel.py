...
class ConfigModel(BaseModel):
    ...
    disqus_shortname = TextField(null = True, default="") # disqus site_shortname
    site_title  = TextField(null=True, default="") # site title
    twitter_username = TextField(null=True, default = "") 

    show_gallery = BooleanField(default=False) # show gallery
    show_projects = BooleanField(default=False) # show projects
    show_about = BooleanField(default=False) # show about page
    show_archives = BooleanField(default=False) # show archives page
